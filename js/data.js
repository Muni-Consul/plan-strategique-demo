...
function loadDemoData() {
  ...
  APP.actions = [
    { id:'1', titre:'Déploiement intranet SharePoint',    axe:'A1', resp:'M. Tremblay', prio:'haute',   echeance:'2026-03-31', dateDebut:'2025-04-01', pct:90,  statut:'en cours',   desc:'Migration complète vers SharePoint Online. Formation terminée.' },
    { id:'2', titre:'Automatisation des processus RH',   axe:'A1', resp:'S. Gagné',    prio:'haute',   echeance:'2026-06-30', dateDebut:'2025-07-01', pct:45,  statut:'en cours',   desc:'Power Automate pour les flux d\'approbation RH.' },
    ...
    { id:'4', titre:'Formation cybersécurité',           axe:'A1', resp:'L. Bouchard', prio:'haute',   echeance:'2025-12-31', dateDebut:'2025-01-01', pct:30,  statut:'en retard',  desc:'Retard dû à la refonte du contenu pédagogique.' },
    { id:'5', titre:'Refonte du portail client',         axe:'A2', resp:'A. Roy',      prio:'haute',   echeance:'2026-06-30', dateDebut:'2025-10-01', pct:65,  statut:'en cours',   desc:'Nouveau portail en développement. Tests UX prévus en avril.' },
    { id:'6', titre:'Programme fidélisation',            axe:'A2', resp:'P. Lavoie',   prio:'moyenne', echeance:'2026-09-30', dateDebut:'2026-04-01', pct:20,  statut:'en cours',   desc:'Étude de marché complétée. Conception en cours.' },
    ...
    { id:'8', titre:'Centre de service amélioré',        axe:'A2', resp:'D. Fortin',   prio:'haute',   echeance:'2025-11-30', dateDebut:'2025-05-01', pct:15,  statut:'en retard',  desc:'Implémentation du CRM retardée.' },
    { id:'9', titre:'Plan de relève cadres',             axe:'A3', resp:'N. Bergeron', prio:'haute',   echeance:'2026-05-31', dateDebut:'2026-01-01', pct:55,  statut:'en cours',   desc:'Identification des postes clés complétée.' },
    { id:'10',titre:'Programme mentorat interne',        axe:'A3', resp:'F. Dubois',   prio:'moyenne', echeance:'2026-07-31', dateDebut:'2026-06-01', pct:0,   statut:'à faire',    desc:'Lancement prévu en juin 2026.' },
    ...
    { id:'12',titre:'Formation leadership',              axe:'A3', resp:'S. Gagné',    prio:'haute',   echeance:'2025-10-31', dateDebut:'2025-03-01', pct:40,  statut:'en retard',  desc:'Fournisseur externe non disponible, report Q2 2026.' },
    { id:'13',titre:'Révision processus achats',         axe:'A4', resp:'H. Leblanc',  prio:'haute',   echeance:'2026-04-30', dateDebut:'2025-10-01', pct:70,  statut:'en cours',   desc:'Cartographie terminée. Procédures en révision.' },
    { id:'14',titre:'Certification ISO 9001',            axe:'A4', resp:'R. Pelletier',prio:'haute',   echeance:'2026-12-31', dateDebut:'2026-01-01', pct:35,  statut:'en cours',   desc:'Audit interne prévu en mai. GAP analysis complétée.' },
    ...
    { id:'16',titre:'Laboratoire d\'innovation',         axe:'A5', resp:'V. Simard',   prio:'moyenne', echeance:'2026-09-30', dateDebut:'2026-02-01', pct:25,  statut:'en cours',   desc:'Espace identifié. Budget approuvé.' },
    ...
    { id:'18',titre:'Projet pilote IA générative',       axe:'A5', resp:'A. Roy',      prio:'haute',   echeance:'2026-06-30', dateDebut:'2026-01-01', pct:50,  statut:'en cours',   desc:'Phase 1 complétée. Résultats positifs.' },
  ];
  APP.jalons = [
